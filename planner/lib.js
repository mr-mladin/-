...
export const Icon = {
  ...
  // Чек-лист (переключатель «Задача»): два контурных кружка (как в оригинале), у верхнего
  // галочка внутри; справа линии. Кружки крупнее + тонкая обводка (.ed-typebtn .ico) — лёгкий,
  // нежирный контур (пропорция обводка/кружок задаёт «тонкость», а не размер на экране).
  checklist: () => wrap(html`<circle cx="5.6" cy="7.5" r="3.4"/><path d="M4.2 7.55l0.85 0.9 1.6-1.85"/><circle cx="5.6" cy="16.5" r="3.4"/><path d="M11.5 7.5H20"/><path d="M11.5 16.5H20"/>`),
