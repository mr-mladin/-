...
export const Icon = {
  ...
  // галочка внутри; справа линии. Толщину линий делаем тоньше через CSS (.ed-typebtn .ico).
  checklist: () => wrap(html`<circle cx="5.5" cy="7.5" r="3"/><path d="M4.5 7.55l0.75 0.8 1.4-1.6"/><circle cx="5.5" cy="16.5" r="3"/><path d="M11 7.5H19"/><path d="M11 16.5H19"/>`),
