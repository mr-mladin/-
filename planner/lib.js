...
export const Icon = {
  ...
  checklist: () => wrap(html`<circle cx="6.5" cy="6.5" r="3.4" fill="currentColor"/><path class="ed-task-check" d="M5.0 6.55l1.0 1.05 1.85-2.1"/><circle cx="6.5" cy="17.5" r="3.4"/><path d="M12.4 6.5H20.9"/><path d="M12.4 17.5H20.9"/>`),
